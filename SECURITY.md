...
- **GitHub private disclosure:** Use the [Security tab](https://github.com/TadMSTR/jobsearch-mcp/security/advisories/new) to submit a private advisory.
- **Email:** Send a description to `security.i9v75@8alias.com` with the subject line `[jobsearch-mcp] Security Report`.
...
- SSRF via job board API endpoint URLs
- Injection in search queries or filters passed to external job APIs
- Information disclosure through stored search results or cached responses
- Dependency vulnerabilities with a plausible exploitation path in jobsearch-mcp's usage
